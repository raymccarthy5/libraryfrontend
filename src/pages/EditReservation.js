            ...
            <Card.Body>
              ...
              <Card.Text>
                ...
                { reservation.checkedOutAt ? (
                  <button 
                    onClick={() => handleShowExtendModal(reservation.id)}
                    disabled={reservation.returned}
                    className={reservation.returned ? "btn btn-secondary" : "button"}
                    >
                      Extend
                    </button>
                    ) : ( 
                    <button
                      disabled={!reservation.checkedOutAt || reservation.returned}
